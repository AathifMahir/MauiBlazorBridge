...
public abstract class BridgeFrameworkHandlerAsync<T>
{
    ...
    protected abstract Task<T> HandleMauiAsync();

    /// <summary>
    /// Handles the Blazor framework asynchronously.
    /// </summary>
    /// <returns>A task representing the asynchronous operation.</returns>
    protected abstract Task<T> HandleBlazorAsync();
...
public abstract class BridgeFrameworkHandlerAsync
{
    ...
    /// </summary>
    /// <returns>A task representing the asynchronous operation.</returns>
    protected abstract Task HandleMauiAsync();

    /// <summary>
    /// Handles the Blazor framework asynchronously.
    /// </summary>
    /// <returns>A task representing the asynchronous operation.</returns>
    protected abstract Task HandleBlazorAsync();
